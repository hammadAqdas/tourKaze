...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWRhc2phZHNoYWtpbCIsImEiOiJja3dtNHJrNmgwNTRuMnhxdGxmeTN3bXp5In0.p-ZgpTYMptcn8-i3Gj75EQ';
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              withCredentials: true,
              url: 'http://localhost:8000/api/v1/users/logout' // url: 'http://127.0.0.1:3000/api/v1/users/logout'
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51K2yufSE4k0wagIOKRqB4RYAaEF1HKOZmuVTjiWrXtqIX8mKpoAUq9T6VQVi4kmobZZUUgLfPLdgJ4r5urG7gNLB00f2Izod97');
            _context.prev = 1;
            _context.next = 4;
